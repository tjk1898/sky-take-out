...
public class EmployeeController {
    ...
    public Result<EmployeeLoginVO> login(@RequestBody EmployeeLoginDTO employeeLoginDTO) {
        ...
        List<Role> roles = roleService.getRolesByEmployeeId(employee.getId());
    ...
    public Result<EmployeeVO> getById(@PathVariable Long id) {
        ...
        if (employee == null) {
            ...
            String roleName = roleService.getRolesByEmployeeId(id).get(0).getName();

            String[] permissions = permissionService.getPermissionsByEmployeeId(id).stream()
